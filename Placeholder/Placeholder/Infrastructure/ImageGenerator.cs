...
namespace Placeholder.Infrastructure
{
	...
	public class ImageGenerator
	{
		...
		{
			text = String.IsNullOrEmpty(text) ? String.Format("{0}x{1}", width, height) : text;
			// Size
			...
			{
				using (Font font = new Font("Verdana", Math.Min(height / 3, width / label.Length), FontStyle.Regular, GraphicsUnit.Pixel))
